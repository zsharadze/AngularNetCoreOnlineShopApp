# Angular 18 Online Shop Application with ASP.NET Core 9 Web Api at backend.
...
![screenshot](https://github.com/zsharadze/AngularNetCoreOnlineShopApp/blob/master/Capture1.PNG?v=nimg&raw=true)
