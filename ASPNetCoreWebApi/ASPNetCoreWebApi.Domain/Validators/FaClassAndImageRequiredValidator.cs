...
namespace ASPNetCoreWebApi.Domain.Validators
{
    ...
    public class FaClassAndImageRequiredValidatorAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (validationContext.ObjectInstance is CategoryDTO categoryDto && string.IsNullOrWhiteSpace(categoryDto.FaClass) && string.IsNullOrWhiteSpace(categoryDto.ImageName) && categoryDto.Image == null)
